...
declare module "packages/net/fabricmc/fabric/impl/networking/server/$ServerPlayNetworkAddon" {
...
import {$ResourceLocation, $ResourceLocation$Type} from "packages/net/minecraft/resources/$ResourceLocation"
import {$ServerboundCustomPayloadPacket, $ServerboundCustomPayloadPacket$Type} from "packages/net/minecraft/network/protocol/game/$ServerboundCustomPayloadPacket"
import {$ServerPlayNetworking$PlayChannelHandler, $ServerPlayNetworking$PlayChannelHandler$Type} from "packages/net/fabricmc/fabric/api/networking/v1/$ServerPlayNetworking$PlayChannelHandler"
 ...
 */
declare global {
export type $ServerPlayNetworkAddon_ = $ServerPlayNetworkAddon$Type;
}}
...
export interface $QuadEmitter extends $MutableQuadView {
 ...
 "color"(c0: integer, c1: integer, c2: integer, c3: integer): $QuadEmitter
...
declare module "packages/net/fabricmc/fabric/api/networking/v1/$ServerPlayNetworking$PlayChannelHandler" {
import {$ServerGamePacketListenerImpl, $ServerGamePacketListenerImpl$Type} from "packages/net/minecraft/server/network/$ServerGamePacketListenerImpl"
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ServerPlayNetworking$PlayChannelHandler$Type = ($ServerPlayNetworking$PlayChannelHandler);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ServerPlayNetworking$PlayChannelHandler_ = $ServerPlayNetworking$PlayChannelHandler$Type;
}}
...
declare module "packages/net/fabricmc/fabric/api/entity/event/v1/$FabricElytraItem" {
import {$ItemStack, $ItemStack$Type} from "packages/net/minecraft/world/item/$ItemStack"
import {$LivingEntity, $LivingEntity$Type} from "packages/net/minecraft/world/entity/$LivingEntity"

export interface $FabricElytraItem {
...
export namespace $FabricElytraItem {
const probejs$$marker: never
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $FabricElytraItem$Type = ($FabricElytraItem);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $FabricElytraItem_ = $FabricElytraItem$Type;
}}
...
declare module "packages/net/fabricmc/fabric/api/object/builder/v1/block/$FabricBlockSettings" {
import {$ToIntFunction, $ToIntFunction$Type} from "packages/java/util/function/$ToIntFunction"
...
export class $FabricBlockSettings extends $BlockBehaviour$Properties {
...
public static "copyOf"(block: $BlockBehaviour$Type): $FabricBlockSettings
public static "copyOf"(settings: $BlockBehaviour$Properties$Type): $FabricBlockSettings
/**
 * 
 * @deprecated
 */
public static "of"(): $FabricBlockSettings
public static "create"(): $FabricBlockSettings
public "offset"(offsetType: $BlockBehaviour$OffsetType$Type): $FabricBlockSettings
public "requires"(...features: ($FeatureFlag$Type)[]): $FabricBlockSettings
public "jumpVelocityMultiplier"(jumpVelocityMultiplier: float): $FabricBlockSettings
public "noBlockBreakParticles"(): $FabricBlockSettings
public "collidable"(collidable: boolean): $FabricBlockSettings
public "solidBlock"(predicate: $BlockBehaviour$StatePredicate$Type): $FabricBlockSettings
public "slipperiness"(value: float): $FabricBlockSettings
public "velocityMultiplier"(velocityMultiplier: float): $FabricBlockSettings
public "suffocates"(predicate: $BlockBehaviour$StatePredicate$Type): $FabricBlockSettings
public "pistonBehavior"(pistonBehavior: $PushReaction$Type): $FabricBlockSettings
public "emissiveLighting"(predicate: $BlockBehaviour$StatePredicate$Type): $FabricBlockSettings
public "blockVision"(predicate: $BlockBehaviour$StatePredicate$Type): $FabricBlockSettings
public "requiresTool"(): $FabricBlockSettings
public "ticksRandomly"(): $FabricBlockSettings
public "burnable"(): $FabricBlockSettings
public "dropsLike"(block: $Block$Type): $FabricBlockSettings
public "dynamicBounds"(): $FabricBlockSettings
/**
 * 
 * @deprecated
 */
public "materialColor"(color: $MapColor$Type): $FabricBlockSettings
/**
 * 
 * @deprecated
 */
public "materialColor"(color: $DyeColor$Type): $FabricBlockSettings
public "breakInstantly"(): $FabricBlockSettings
public "dropsNothing"(): $FabricBlockSettings
public "notSolid"(): $FabricBlockSettings
public "strength"(hardness: float, resistance: float): $FabricBlockSettings
public "strength"(strength: float): $FabricBlockSettings
public "air"(): $FabricBlockSettings
public "postProcess"(predicate: $BlockBehaviour$StatePredicate$Type): $FabricBlockSettings
public "instrument"(instrument: $NoteBlockInstrument$Type): $FabricBlockSettings
public "liquid"(): $FabricBlockSettings
public "resistance"(resistance: float): $FabricBlockSettings
public "replaceable"(): $FabricBlockSettings
public "solid"(): $FabricBlockSettings
public "mapColor"(mapColorProvider: $Function$Type<($BlockState$Type), ($MapColor$Type)>): $FabricBlockSettings
public "mapColor"(color: $MapColor$Type): $FabricBlockSettings
public "mapColor"(color: $DyeColor$Type): $FabricBlockSettings
public "allowsSpawning"(predicate: $BlockBehaviour$StateArgumentPredicate$Type<($EntityType$Type<(any)>)>): $FabricBlockSettings
public "hardness"(hardness: float): $FabricBlockSettings
public "noCollision"(): $FabricBlockSettings
public "nonOpaque"(): $FabricBlockSettings
public "drops"(dropTableId: $ResourceLocation$Type): $FabricBlockSettings
/**
 * 
 * @deprecated
 */
public "lightLevel"(lightLevel: integer): $FabricBlockSettings
/**
 * 
 * @deprecated
 */
public "lightLevel"(levelFunction: $ToIntFunction$Type<($BlockState$Type)>): $FabricBlockSettings
public "sounds"(group: $SoundType$Type): $FabricBlockSettings
public "luminance"(luminanceFunction: $ToIntFunction$Type<($BlockState$Type)>): $FabricBlockSettings
public "luminance"(luminance: integer): $FabricBlockSettings
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $FabricBlockSettings$Type = ($FabricBlockSettings);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $FabricBlockSettings_ = $FabricBlockSettings$Type;
}}
