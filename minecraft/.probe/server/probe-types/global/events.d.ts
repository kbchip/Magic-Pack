...
import {$EntitySpellCastEventJS, $EntitySpellCastEventJS$Type} from "packages/com/squoshi/irons_spells_js/events/$EntitySpellCastEventJS"
...
import {$SpellOnCastEventJS, $SpellOnCastEventJS$Type} from "packages/com/squoshi/irons_spells_js/events/$SpellOnCastEventJS"
import {$RecipesEventJS, $RecipesEventJS$Type} from "packages/dev/latvian/mods/kubejs/recipe/$RecipesEventJS"
import {$EntitySpellPreCastEventJS, $EntitySpellPreCastEventJS$Type} from "packages/com/squoshi/irons_spells_js/events/$EntitySpellPreCastEventJS"
...
import {$SpellPreCastEventJS, $SpellPreCastEventJS$Type} from "packages/com/squoshi/irons_spells_js/events/$SpellPreCastEventJS"
...
import {$ChangeManaEventJS, $ChangeManaEventJS$Type} from "packages/com/squoshi/irons_spells_js/events/$ChangeManaEventJS"
...
function spellPreCast(handler: (event: $EntitySpellPreCastEventJS) => void): void
function spellOnCast(handler: (event: $EntitySpellCastEventJS) => void): void
