...
function tags(extra: "worlds_together:worldgen/betterx/biome_codec", handler: (event: TagEventProbe<(Special.WorldgenBetterxBiomeCodecTag), (Special.WorldgenBetterxBiomeCodec)>) => void): void
...
function tags(extra: "lionfishapi:modded_biome_slices", handler: (event: TagEventProbe<(Special.ModdedBiomeSlicesTag), (Special.ModdedBiomeSlices)>) => void): void
function tags(extra: "worlds_together:worldgen/betterx/surface_rules", handler: (event: TagEventProbe<(Special.WorldgenBetterxSurfaceRulesTag), (Special.WorldgenBetterxSurfaceRules)>) => void): void
...
function tags(extra: "worlds_together:worldgen/betterx/biome", handler: (event: TagEventProbe<(Special.WorldgenBetterxBiomeTag), (Special.WorldgenBetterxBiome)>) => void): void
}
}