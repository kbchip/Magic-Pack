...
function addTags<T>(arg0: $TagsProvider$TagAppender$Type<(T)>, ...arg1: ($TagKey$Type<(T)>)[]): $TagsProvider$TagAppender<(T)>
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
export interface $IForgeItem extends $FabricItem, $IForgeItemMixin {
 ...
 "handler$dmk000$connectormod$redirectIsPiglinCurrency"(arg0: $ItemStack$Type, arg1: $CallbackInfoReturnable$Type<(any)>): void
...
(arg0: $EquipmentSlot$Type, arg1: $ItemStack$Type): $Multimap<($Attribute), ($AttributeModifier)>
}
...
export interface $IShapedRecipe<T extends $Container> extends $Recipe<(T)> {
 ...
 "handler$bhj000$bclib$bcl_getRemainingItems"(container: $Container$Type, cir: $CallbackInfoReturnable$Type<(any)>): void
...
import {$LivingEntityAccess, $LivingEntityAccess$Type} from "packages/org/infernalstudios/shieldexp/access/$LivingEntityAccess"
...
public static "get"(arg0: any): $LivingEntityAccess
...
declare module "packages/net/minecraftforge/client/extensions/$IAbstractWidgetExtension" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
...
readonly "ids": $Map<($ResourceLocation), (integer)>
readonly "aliases": $Map<($ResourceLocation), ($ResourceLocation)>
readonly "blocked": $Set<(integer)>
...
public "loadIds"(arg0: $Map$Type<($ResourceLocation$Type), (integer)>, arg1: $Map$Type<($ResourceLocation$Type), (string)>, arg2: $Map$Type<($ResourceLocation$Type), (integer)>, arg3: $Map$Type<($ResourceLocation$Type), ($IdMappingEvent$IdRemapping$Type)>, arg4: $ForgeRegistry$Type<(V)>, arg5: $ResourceLocation$Type): void
public "getMissingEvent"(arg0: $ResourceLocation$Type, arg1: $Map$Type<($ResourceLocation$Type), (integer)>): $MissingMappingsEvent
public "bake"(): void
...
declare module "packages/net/minecraftforge/common/damagesource/$IScalingFunction" {
import {$Player, $Player$Type} from "packages/net/minecraft/world/entity/player/$Player"
import {$DamageSource, $DamageSource$Type} from "packages/net/minecraft/world/damagesource/$DamageSource"
...
(arg0: $DamageSource$Type, arg1: $Player$Type, arg2: float, arg3: $Difficulty$Type): float
}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $IScalingFunction$Type = ($IScalingFunction);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
...
declare module "packages/net/minecraftforge/common/damagesource/$IDeathMessageProvider" {
import {$Component, $Component$Type} from "packages/net/minecraft/network/chat/$Component"
...
(arg0: $LivingEntity$Type, arg1: $CombatEntry$Type, arg2: $CombatEntry$Type): $Component
}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $IDeathMessageProvider$Type = ($IDeathMessageProvider);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
