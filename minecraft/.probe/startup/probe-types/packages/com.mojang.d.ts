...
export class $BufferBuilder extends $DefaultedVertexConsumer implements $BufferVertexConsumer, $BufferBuilderExtension, $BlockSensitiveBufferBuilder, $ExtendingBufferBuilder, $IrisExtendedBufferBuilder, $MemoryTrackingBuffer, $IBufferBuilder, $ExtendedBufferBuilder, $VertexBufferWriter, $BufferBuilderExt {
 "format": $VertexFormat
...
public "localvar$eke000$oculus$vertex"(alpha: float): float
...
public static "addKey"(arg0: $InputConstants$Type$Type, arg1: string, arg2: integer): void
...
static readonly "NAME_MAP": $Map<(string), ($InputConstants$Key)>
