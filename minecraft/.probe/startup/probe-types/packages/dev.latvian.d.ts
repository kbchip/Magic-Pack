...
(cx: $Context$Type, scope: $Scriptable$Type, args: (any)[]): any
}
...
import {$EntityType, $EntityType$Type} from "packages/net/minecraft/world/entity/$EntityType"
import {$ClientInitISSKJS, $ClientInitISSKJS$Type} from "packages/com/squoshi/irons_spells_js/util/$ClientInitISSKJS"
...
public "handler$zzp000$probejs$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
...
(renderer: $CompoundTag$Type): void
}
